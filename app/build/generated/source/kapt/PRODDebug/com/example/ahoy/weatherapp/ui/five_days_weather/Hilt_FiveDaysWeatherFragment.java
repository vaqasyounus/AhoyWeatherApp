...
public abstract class Hilt_FiveDaysWeatherFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_FiveDaysWeatherFragment() {
    super();
  }

  Hilt_FiveDaysWeatherFragment(int arg0) {
    super(arg0);
  }
  ...
  protected void inject() {
    ((FiveDaysWeatherFragment_GeneratedInjector) generatedComponent()).injectFiveDaysWeatherFragment(UnsafeCasts.<FiveDaysWeatherFragment>unsafeCast(this));
  }
