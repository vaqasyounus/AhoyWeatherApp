...
public abstract class Hilt_CurrentWeatherFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_CurrentWeatherFragment() {
    super();
  }

  Hilt_CurrentWeatherFragment(int arg0) {
    super(arg0);
  }
  ...
  protected void inject() {
    ((CurrentWeatherFragment_GeneratedInjector) generatedComponent()).injectCurrentWeatherFragment(UnsafeCasts.<CurrentWeatherFragment>unsafeCast(this));
  }
